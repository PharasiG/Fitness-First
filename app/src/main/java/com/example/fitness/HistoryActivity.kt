...
class HistoryActivity : AppCompatActivity() {
    ...
    private fun makeRow(textsContent: ArrayList<String>, index: Int = 0): TableRow {
        ...
        val row = TableRow(this).apply {
            ...
            if ((index % 2) == 0)
                setBackgroundColor(getColorByApi(R.color.colorText))
        }
    ...
    private fun makeTextView(contentText: String): TextView {
        return TextView(this).apply {
            text = contentText
            setTextColor(getColorByApi(com.google.android.material.R.color.design_default_color_background))
    ...
    private fun getColorByApi(id: Int): Int {
