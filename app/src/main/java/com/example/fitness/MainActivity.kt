...
import com.example.fitness.util.CONGRATULATIONS
import com.example.fitness.viewModel.MainViewModel
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private val percentText by lazy {
        findViewById<TextView>(R.id.percentText)
    }
    private val congratulationsTxt by lazy {
        findViewById<TextView>(R.id.congratulationsTxt)
    }
    private val qtToDrink by lazy {
        findViewById<TextView>(R.id.qtToDrink)
    }
